...
export default function StudentSettings() {
 ...
 <CardDescription>Update your email address and profile information.</CardDescription>
 </CardHeader>
 ...
 <div>
 <p className="font-semibold text-white">Opportunity Matches</p>
 <p className="text-xs text-muted-foreground">Receive emails when highly matched opportunities are found.</p>
 </div>
